...
const page = () => {
  return (
    <>
      ...
      <div className="card Aligner-item">
        <div className="icon">
          <svg
        ...
        <p>
          ...
          <span className="emphasize"> non payment of dues</span>. If you own this
          website, please pay the dues in full before
          <span className="emphasize">Feb 20th, 2020</span> to avoid permanent
