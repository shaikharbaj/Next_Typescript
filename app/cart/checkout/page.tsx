    ...
    const submitHandler =()=>{
          ...
          if(Object.keys(validate)?.length>0){
            ...
            const itempayload = cartItem?.map((p:any)=>{
                      return {productId:Number(p.product.id),quantity:Number(p.quantity),price:parseFloat(p.product.discountprice)}
            })
            const payload = {
                "shippingDetails": {
                  "name": shippingName,
        ...
        <>
                        ...
                        {cartItem?.length > 0 &&
                            cartItem.map((p: any) => {
                                return (
                                    ...
                                    <CheckoutProductCard data={p} key={p?.product.id} />
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    {error?.shippingName && <p className="error">{error?.shippingName}</p>}
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    {error?.shippingEmail && <p className="error">{error?.shippingEmail}</p>}
                                </div>
                                ...
                                <div>
                                    ...
                                    {error?.shippingCountry && <p className="error">{error?.shippingCountry}</p>}
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    {error?.shippingState && <p className="error">{error?.shippingState}</p>}
                                </div>
                                <div>
                                    <label
                                        htmlFor="city"
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    {error?.shippingCity && <p className="error">{error?.shippingCity}</p>}
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    {error?.shippingPhone && <p className="error">{error?.shippingPhone}</p>}
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    {error?.shippingAddressLine1 && <p className="error">{error?.shippingAddressLine1}</p>}
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    {error?.shippingZipCode && <p className="error">{error?.shippingZipCode}</p>}
                                </div>
            ...
            <div className="flex flex-col sm:flex-row">
              ...
              />
                    ...
                    <button className="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white" onClick={submitHandler}>
                        Place Order
                    </button>
                </div>
            </div>
