...
import { addCategoryAsync } from '@/app/Redux/features/category/categorySlice'
const AddCategory = () => {
    ...
    const submitHandler = () => {
        ...
        dispatch(addCategoryAsync(payload)).unwrap().then((res) => {
                            ...
                            <div className="card-body">
                                <div className="row gutters">
                                    <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <h6 className="mb-2 text-primary">Add Category</h6>
                                    </div>
